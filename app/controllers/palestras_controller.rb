class PalestrasController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to palestras_path, status: :see_other, notice: "Palestra was successfully destroyed." }
  ...
  private
    ...
    def palestra_params
      params.require(:palestra).permit(:titulo, :data, :horario, :local, :valor)
    end
end
