...
class ParticipantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participante" do
    assert_difference("Participante.count") do
      post participantes_url, params: { participante: { email: @participante.email, nome: @participante.nome, telefone: @participante.telefone } }
    end
  ...
  test "should update participante" do
    patch participante_url(@participante), params: { participante: { email: @participante.email, nome: @participante.nome, telefone: @participante.telefone } }
